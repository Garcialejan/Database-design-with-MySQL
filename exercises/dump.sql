...
-- ! Autogeneramos la BB.DD de insurances.sql con un dump desde la terminal mysqldump -u root -h 127.0.0.1 -P 3306 -p insurances > dump.sql
...
CREATE TABLE `insurances` (
  ...
  CONSTRAINT `CONSTRAINT_1` CHECK (`percentage_covered` <= 100)
...
-- Dump completed on 2024-03-24 19:41:48
